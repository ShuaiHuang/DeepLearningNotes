...
通过对$J$在点$\bm w^\ast={\arg\min}_{\bm w}J(\bm w)$做二次展开,并加上正则化项求导,设在$\tilde{\bm w}$导数为0,有
...
相应的,解为
\begin{equation}
{\bm\theta}^\ast={\arg\min}_{\bm\theta}\max_{\alpha,\alpha\ge 0}\mathcal L({\bm\theta},\alpha)
\end{equation}
